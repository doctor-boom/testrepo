...
spacex_df = pd.read_csv("M3-spacex_launch_dash.csv")
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        values='class', 
        names='Launch Site', 
        title='Percent of Success Launches By Site')
        return fig
    else:
...
def get_scatter_chart(entered_site, slider_val):
    filtered_df = spacex_df
    if entered_site == 'ALL':
        # return a scatter chart for all sites
        ...
        # return a scatter chart for the selected site
        data = filtered_df[filtered_df['Launch Site'] == entered_site]
